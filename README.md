...
| **8** | [<img src="https://github.com/DarkHorse313.png?size=50" width="40" height="40" style="border-radius:50%" alt="DarkHorse313" /><br /><sub><b>DarkHorse313</b></sub>](https://github.com/DarkHorse313) | **[Closed Issues](https://github.com/REBEL-ROOT/omni-browser/issues?q=is%3Aissue%20state%3Aclosed%20author%3ADarkHorse313)** — Provided multiple valuable bug reports and detailed testing feedback on closed issues. |
| **9** | [<img src="https://github.com/Sunnu126.png?size=50" width="40" height="40" style="border-radius:50%" alt="Sunnu126" /><br /><sub><b>Sunnu126</b></sub>](https://github.com/Sunnu126) | **#49** — Detailed extension toggle bug report on Samsung S20 FE 5G (Android 13). |
| **10** | [<img src="https://github.com/Phinixprono123.png?size=50" width="40" height="40" style="border-radius:50%" alt="Phinixprono123" /><br /><sub><b>Phinixprono123</b></sub>](https://github.com/Phinixprono123) | **#54** — Crucial compatibility bug report regarding settings crash on Vivo Y85 (Android 8.1 Oreo). |
